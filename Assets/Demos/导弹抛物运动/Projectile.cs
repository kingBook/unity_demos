...
// 教程解析：https://vilbeyli.github.io/Projectile-Motion-Tutorial-for-Arrows-and-Missiles-in-Unity3D/

[RequireComponent(typeof(Rigidbody))]
public class Projectile : MonoBehaviour
{
    // launch variables
    [SerializeField] private UnityEngine.Transform TargetObjectTF;
    ...
    float GetPlatformOffset()
    {
        ...
        foreach (UnityEngine.Transform childTransform in TargetObjectTF.GetComponentsInChildren<UnityEngine.Transform>())
        {
    ...
    void SetNewTarget()
    {
        UnityEngine.Transform targetTF = TargetObjectTF.GetComponent<UnityEngine.Transform>(); // shorthand
